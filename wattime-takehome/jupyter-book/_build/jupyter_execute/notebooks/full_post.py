...
# 
# The 20 and 100 year warming potentials for methane emsission are 84 and 28 [(WG1AR5_Chapter08, Pg 73)](https://www.ipcc.ch/site/assets/uploads/2018/02/WG1AR5_Chapter08_FINAL.pdf).  These factors will impact our climate if nothing is done.  Unfortunately, the countries that produce the most methane from rice cultivation are also those most dependent on the grain.  To make the change, realistic solutions must be provided to feed people culturally and geographically dependent on rice cultivation.    
# 
